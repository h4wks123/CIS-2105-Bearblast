        <!-- Side nav (Admin)-->
        <div class="flex-column p-3" style="width: 280px; position: fixed; height: 100%; background-color: #455774;">
            <ul class="nav nav-pills flex-column" style="margin-bottom: 475px;">
                <!-- Account dropdown -->
                <div class="dropdown m-3">
                    <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false" style="color: white;">
                        ...
                        <strong><b><?php session_start();
                                echo $_SESSION['email'];
                                $users_idA = $_SESSION['users_id']; ?></b></strong>
                    </a>
                </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="food_products.php" style="color: white;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="pending_orders_admin.php" style="color: white;">
                        ...
                        <b>Pending Orders</b></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="delivery.php" style="color: white;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="sales.php" style="color: white;">
                ...
                <li class="nav-item" style="position: absolute; bottom: 10">
                    </br>
